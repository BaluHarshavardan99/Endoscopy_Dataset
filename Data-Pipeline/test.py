...
for i in video_file_names:
    ...
    keyframe_folder = "/home/easgrad/baluhars/1234567890/Video_Dataset/SUNDAY_TEST/keyframes_images/" + i[:-4]
    ...
    keyframe_txt = "/home/easgrad/baluhars/1234567890/Video_Dataset/SUNDAY_TEST/keyframe_txt_folder/" + i[:-4] + '.txt'
    keyframes_timestamps = "/home/easgrad/baluhars/1234567890/Video_Dataset/SUNDAY_TEST/keyframe_timestamps_folder/" + i[:-4] + "_timestamps.txt"
