...
def clip_audio2text(audio):
    ...
    with open("/home/easgrad/baluhars/1234567890/Video_Dataset/SUNDAY_TEST/COMBINED_DATASET/audio_bits/output_text.txt", "w") as f:
...
audio_folder_path = "/home/easgrad/baluhars/1234567890/Video_Dataset/SUNDAY_TEST/COMBINED_DATASET/AUDIO"
audio_file_names = os.listdir(audio_folder_path)
#print(video_file_names)

# Define the CSV file path
csv_file_path = "/home/easgrad/baluhars/1234567890/Video_Dataset/SUNDAY_TEST/COMBINED_DATASET/results.csv"
text_csv_file_path = "/home/easgrad/baluhars/1234567890/Video_Dataset/SUNDAY_TEST/COMBINED_DATASET/text_csv_file.csv"
image_paths_csv_file_path = "/home/easgrad/baluhars/1234567890/Video_Dataset/SUNDAY_TEST/COMBINED_DATASET/image_paths.csv"
        ...
        with open(text_csv_file_path, mode='w', newline='') as text_file:
            ...
            for i, video_name in enumerate(video_file_names, start=1):
                if COUNTER < 300:
                    ...
                    timestamps_txt = "/home/easgrad/baluhars/1234567890/Video_Dataset/SUNDAY_TEST/COMBINED_DATASET/keyframe_timestamps_folder/"+ video_name[:-4] +"_timestamps.txt"
                    ...
                    clip_path = "/home/easgrad/baluhars/1234567890/Video_Dataset/SUNDAY_TEST/COMBINED_DATASET/keyframes_images/"
                    ...
                    for chunk_id, chunk in enumerate(chunks_images):
                        ...
                        #     # image_paths_writer.writerow([vid_id, chunk_id, image_paths[image_idx]])
                        #     image_paths_writer.writerow([vid_id, chunk_id, image_paths[int(image_idx)]])
                    ...
                    # # Write the data to the CSV file
                    # writer.writerow([i, vid_id, keyframes, predictions, chunks, chunks_images, chunks_image_times])
                    # print("CSV file for video: {} created successfully!" .format(video_name))
                    ...
                    for chunk_id, chunk in enumerate(chunks):
                        ...
                        output_audio_path = "/home/easgrad/baluhars/1234567890/Video_Dataset/SUNDAY_TEST/COMBINED_DATASET/audio_bits/output_segment.mp3"
                        ...
                        with open('/home/easgrad/baluhars/1234567890/Video_Dataset/SUNDAY_TEST/COMBINED_DATASET/audio_bits/output_text.txt', 'r') as text_file:
